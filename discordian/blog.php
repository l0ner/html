...
<?php get_header(); ?>	
	<div id="wrapper">
		...
		<div id="content-wrapper">
			...
			<div>posted by: <?php the_author() ?>  in <?php the_category(', ') ?>  on <?php the_time('m jS, Y') ?><strong> | </strong> <?php edit_post_link('Edit','','<strong>|</strong>'); ?> | <?php comments_popup_link('No Comments &raquo;', '1 Comment &raquo;', '% Comments &raquo;'); ?></div>
</div>
